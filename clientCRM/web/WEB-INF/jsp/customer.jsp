            ...
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/customer/list" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="customerName" value="${custName }" name="custName"><!--custName-->
                    </div>
                    <div class="form-group">
                        <label for="customerFrom">客户来源</label>
                        <select	class="form-control" id="customerFrom" placeholder="客户来源" name="custSource"><!--custSource-->
                    ...
                    <div class="form-group">
                        ...
                        <select	class="form-control" id="custIndustry"  name="custIndustry"><!--custIndustry-->
                            <option value="">--请选择--</option>
                    ...
                    <div class="form-group">
                        ...
                        <select	class="form-control" id="custLevel" name="custLevel"><!--custLevel-->
                            <option value="">--请选择--</option>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <c:forEach items="${page.row}" var="row">
                            <tr>
                                <td>${row.cust_id}</td>
                                <td>${row.cust_name}</td>
                    ...
                    <div class="col-md-12 text-right">
                        <ancrazyking:page url="${pageContext.request.contextPath}/customer/list" />
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
...
<script type="text/javascript">
    //修改一个客户的记录
    //$().val()表示设置一个标签里的值
    //data是通过ajax中url中对应的页面后,返回的值,相当于执行url后那个页面输出的内容
